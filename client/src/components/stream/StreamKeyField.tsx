    ...
    <div className="space-y-4">
      <div className="space-y-1.5">
        ...
        <div className="relative group">
          ...
          <button type="button" onClick={onCopyUrl} className="absolute right-3 top-1/2 -translate-y-1/2 text-secondary hover:text-primary transition-colors">
      ...
      <div className="space-y-1.5">
        ...
        <div className="relative group">
          ...
          <div className="absolute right-2 top-1/2 -translate-y-1/2 flex gap-1">
            <button type="button" onClick={onToggleShowKey} className="p-1.5 text-secondary hover:text-foreground">
              {showStreamKey ? <EyeOff className="w-4 h-4" /> : <Eye className="w-4 h-4" />}
            </button>
            <button type="button" onClick={onCopyKey} className="p-1.5 text-secondary hover:text-foreground">
